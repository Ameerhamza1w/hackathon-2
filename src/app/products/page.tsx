    ...
    <div>
      ...
      <div className="relative bg-gray-100">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-4xl font-bold text-white">Product Comparison</h1>
        </div>
      </div>
      ...
      <div className="max-w-screen-xl mx-auto py-8 px-4">
        <div className="text-center mb-8">
          <h2 className="text-xl font-semibold text-gray-700">Do the Product Comparison</h2>
          ...
          <table className="w-full border-collapse border border-gray-300">
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2">Rp 2,500.000</td>
                <td className="border border-gray-300 px-4 py-2">Rp 3,500.000</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-4 py-2">Material</td>
                <td className="border border-gray-300 px-4 py-2">Wood</td>
                <td className="border border-gray-300 px-4 py-2">Metal</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-4 py-2">Dimensions</td>
                <td className="border border-gray-300 px-4 py-2">50x60x80 cm</td>
                <td className="border border-gray-300 px-4 py-2">60x70x90 cm</td>
              </tr>
              <tr>
