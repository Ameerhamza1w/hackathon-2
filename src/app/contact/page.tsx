...
const page = () => {
  return (
    <div>
      ...
      <div className="w-full max-w-[1183px] px-5 lg:px-0 mx-auto my-10">
        <div className="text-center font-poppins mb-10 mt-8">
          <h5 className="font-bold text-[28px] md:text-[36px]">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="w-full lg:w-[399px]">
            ...
            <div className="flex gap-2">
              ...
              <div>
                <h3 className="font-bold text-base md:text-lg">Working Time</h3>
                <p className="text-sm md:text-base">
          ...
          <div className="w-full">
            <div className="mb-4">
              <label htmlFor="" className="mb-2 block text-sm md:text-base">
                Your name
              </label>
              <input
                type="text"
                className="w-full border rounded-md h-12 md:h-16 border-[#9F9F9F] px-4"
                placeholder="Abc"
              />
            </div>
            <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <textarea
                className="w-full border rounded-md h-24 md:h-32 border-[#9F9F9F] px-4 py-2"
                placeholder="Hi! I’d like to ask about..."
              ></textarea>
            </div>
            <button className="mt-3 w-full lg:w-[222px] py-3 font-poppins font-bold bg-[#B88E2F] text-white">
              Submit
            </button>
          </div>
        </div>
      ...
      <div className="bg-[#FAF3EA] py-20 px-5 lg:px-10 flex flex-wrap justify-between gap-6">
        {[
          ...
          <div key={idx} className="flex gap-4 items-center w-full sm:w-[45%] lg:w-[22%]">
            ...
            <div>
              <h5 className="font-poppins font-bold text-[20px] md:text-[24px]">
                {item.title}
              </h5>
              <p className="text-[#898989] text-sm md:text-base">{item.desc}</p>
            </div>
          </div>
        ))}
      </div>
